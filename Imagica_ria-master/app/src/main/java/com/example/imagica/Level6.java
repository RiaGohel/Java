...
public class Level6 extends AppCompatActivity {
    ...
    private static final String TAG="Level 6";
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView) findViewById(R.id.lev6_1);
        imageView2=(ImageView) findViewById(R.id.lev6_2);
        imageView3=(ImageView) findViewById(R.id.lev6_diff1);
        imageView4=(ImageView) findViewById(R.id.lev6_diff2);
        imageView5=(ImageView) findViewById(R.id.lev6_diff3);
        imageView6=(ImageView) findViewById(R.id.lev6_diff4);
/*
 ...
 */
        ...
        Query query=reference.child("Level6");
