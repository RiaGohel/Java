...
public class Level5 extends AppCompatActivity {
    ...
    private static final String TAG="Level 5";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView) findViewById(R.id.lev5_1);
        imageView2=(ImageView) findViewById(R.id.lev5_2);
        imageView3=(ImageView) findViewById(R.id.lev5_diff1);
        imageView4=(ImageView) findViewById(R.id.lev5_diff2);
        imageView5=(ImageView) findViewById(R.id.lev5_diff3);
        imageView6=(ImageView) findViewById(R.id.lev5_diff4);
        imageView7=(ImageView) findViewById(R.id.lev5_diff5);
        imageView8=(ImageView) findViewById(R.id.lev5_diff6);

        reference= FirebaseDatabase.getInstance().getReference();

        Query query=reference.child("Level5");
